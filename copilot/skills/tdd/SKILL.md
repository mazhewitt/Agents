...
When exploring the codebase, use the project's domain glossary (if one exists) so that test names and interface vocabulary match the project's language, and respect any architecture decision records or design notes in the area you're touching.
